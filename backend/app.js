...
const html_form = `
  ...
  <div class="field">
    ...
    <div class="control">
      <input id="numero class="input" type="number" placeholder="e.g 025">
    </div>

  </div><div class="field">
    <label for="" class="label"> Nombre </label>
    <div class="control">
      <input id="nombre" class="input" type="text" placeholder="e.g Pikachu">
    </div>
  </div>
  ...
  <div class="field">
    ...
    <div class="control">
      <input id="tipo" class="input" type="text" placeholder="e.g Electrico">
    </div>
  </div>
  ...
  <div class="field">
    ...
    <div class="control">
      <input id="region" class="input" type="text" placeholder="e.g Kanto">
    </div>
  </div>
